...
const InteractiveSelector = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-void font-sans text-white"> 
      {/* Header Section */}
      ...
      {/* Options Container */}
      <div className="options flex w-full max-w-[900px] min-w-[800px] h-[600px] mx-0 items-stretch overflow-hidden relative">
