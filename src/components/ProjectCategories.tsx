...
export type CategoryCard = { slug: ProjectCategory; num: string; image: string; count: number }

type CategorySlug = ProjectCategory

export default function ProjectCategories({ categories }: { categories: CategoryCard[] }) {
