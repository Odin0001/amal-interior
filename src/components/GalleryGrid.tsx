...
export default function GalleryGrid({
  ...
  useEffect(() => {
    ...
    linkEl.style.cssText = "display:inline-block;margin-top:0.9rem;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#f5f0eb;border-bottom:1px solid rgba(245,240,235,0.45);padding-bottom:2px;pointer-events:all;cursor:pointer;";
    linkEl.textContent = viewLabel;
    ...
    function enter(item: ItemData) {
      ...
      linkEl.href             = `${basePath}/${item.data.slug}`;
  ...
  if (projects.length === 0) {
    return (
      <div className="flex items-center justify-center h-screen bg-void text-muted text-sm">
